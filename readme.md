...
```python generate-m2-source.py sample/QALB-Test2014.m2  > sample/QALB-Test2014.source.sent```
...
```python generate-m2-reference.py sample/QALB-Test2014.m2 > sample/QALB-Test2014.reference.sent```
